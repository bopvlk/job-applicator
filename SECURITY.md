...
If you find a security vulnerability in job-applicator, please report it through [GitHub's private vulnerability reporting](https://github.com/boplk/job-applicator/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact bopvlk@gmail.comm for details.
