...
```sh
uv add job-applicator
```

### What's in the scaffold

- `src/job_applicator/` package with CLI (Typer + Rich), py.typed marker
...
[@bopvlk](https://github.com/bopvlk) (Bogdan Pavliuk) created job-applicator.
